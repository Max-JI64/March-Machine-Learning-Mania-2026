...
print(f"✅ LightGBM V4 (Individual/Expanded) - 사용 스레드 수: {N_JOBS}")
...
# ==============================================================================
# 5. 하이퍼파라미터 최적화 (V4: V3와 동일 범위 + 확장된 CV)
# ==============================================================================
def objective(trial):
    ...
    # 확장된 검증 기간 중 마지막 3년을 표본으로 최적화 (속도와 안정성 사이의 균형)
    for val_year in val_seasons[-3:]:
        ...
        train_aug = augment_data(train_temp, features, target) # noise 0.03
...
print("\n🚀 1단계: 하이퍼파라미터 최적화 (LightGBM V4, 50 trials)...")
...
# ==============================================================================
print("\n🚀 2단계: 확장된 범위(2013-2025) 최적 설정 최종 성능 평가...")
final_briers = []
