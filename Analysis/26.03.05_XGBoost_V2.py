...
# ==============================================================================
N_JOBS = os.cpu_count()
print(f"✅ XGBoost V2 - CPU 코어 수: {N_JOBS}")
...
# ==============================================================================
# 5. 하이퍼파라미터 최적화 (V2: 정밀 튜닝 + Noise Scale 튜닝)
# ==============================================================================
def objective(trial):
    params = {
        ...
        'objective': 'binary:logistic', 'tree_method': 'hist', 'eval_metric': 'logloss', 'random_state': SEED, 'nthread': N_JOBS
    }
...
print("\n🚀 1단계: 하이퍼파라미터 정밀 최적화 (XGBoost V2, 50 trials)...")
