...
def get_full_los_score(df, features, model_class, params, val_years):
    ...
    for vy in val_years:
        ...
        if model_class == CatBoostRegressor:
            ...
            model = model_class(**params, random_state=SEED, verbose=-1).fit(X_tr, y_tr_smooth)
...
if __name__ == "__main__":
    print("🔥 V46: Rigorous Optuna Hyperparameter Tuning for V43 Baseline")
    ...
    with open('v46_optuna_results.json', 'w') as f:
        json.dump(study_results, f, indent=4)
        
    print("\n✅ V46 Tuning Complete. Best parameters saved to v46_optuna_results.json")
