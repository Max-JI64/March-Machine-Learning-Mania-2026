...
# ==============================================================================
# 2. 모델 학습 엔진 (V40 Full Data + V41 Golden Weights Hardcoded)
# ==============================================================================
# V41 Golden Weights
...
def train_and_eval_season(df_train, val_year, features, cat_p, xgb_p, lgb_p, gender_clip_limits, weights):
    # 🌟 V40: Data Expansion (Leave-One-Season-Out)
...
# 3. 메인 프로세스
# ==============================================================================
print("\n🔥 V42: 2012 Out-of-Distribution Validation with Golden Weights", flush=True)
...
# 🌟 V42 핵심: 2012년부터 검증 시작 (기존은 2013년~)
...
print(f"\n🚀 전체 년도(+2012) 대상 볼륨 학습 & 황금 가중치 로드...", flush=True)
...
for val_year in seasons:
    ...
    # 2012년은 Women's 대회 성적 데이터가 완벽하지 않을 수 있음 보호 구문
    try:
...
print(f"🎯 연속 성능 증진 V42 (2012 OOD Validation) 평균 Brier Score: {np.mean(final_results):.5f}", flush=True)
