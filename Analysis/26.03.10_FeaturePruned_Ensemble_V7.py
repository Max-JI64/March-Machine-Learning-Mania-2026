...
# ==============================================================================
# 파트 I: Advanced Ratings 함수 부분은 생략 없이 유지
# ==============================================================================
...
# 앞서 추출된 Top 33 피처 불러오기
try:
    with open('selected_features_v7.json', 'r') as f:
        features = json.load(f)
    print(f"✅ V7 가지치기 완료 피처 세트 불러옴: {len(features)}개")
except FileNotFoundError:
    print("⚠️ selected_features_v7.json 파일을 찾을 수 없습니다.")
...
print("\n🚀 1단계: 신규 피처셋(33개) 기반 1차 트리 모델 OOF 추출...")
xgb_preds_list = []
lgb_preds_list = []
cat_preds_list = []
y_val_list = []
